...
class App extends Component {
	...
	messages = {
		...
		pass_incorrect: 'Hasło musi być dłuższe niż 8 znaków',
			...
			<div className="App">
				<form action="" noValidate onSubmit={this.handleSubmit}>
					...
					<label htmlFor="accept">
						<input type="checkbox" name="accept" id="accept" onChange={this.handleChange} checked={this.state.accept} /> Wyrażam zgodę wszelaką.
